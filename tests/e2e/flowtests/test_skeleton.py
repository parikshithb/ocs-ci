...
class TestStoryBasedTests(E2ETest):
    ...
    def test_base_operation_add_node(self, pgsql, project_factory, mcg_obj, bucket_factory, multi_pvc_factory):
    # def test_base_operation_add_node(self, project_factory, multi_pvc_factory, pod_factory, multi_dc_pod):
        """
        Test ......
        """
        global OPERATION_COMPLETED
        ...
        obc_ios = executor_run_bg_ios_ops.submit(
            wrapper_obc_io_create_delete, mcg_obj, bucket_factory, 50
        )

        logging.info("Started pvc create delete...")
        pvc_create_delete = executor_run_bg_ios_ops.submit(wrapper_pvc_create_delete, multi_pvc_factory, project, 50)

        logging.info("Started PGSQL IOS...")
        pgsql_create_delete = executor_run_bg_ios_ops.submit(pgsql, 50)

        # logging.info("Started dc pod create delete...")
